...
#define DECL_VECTOR_FN_BENCH(fn)                                        \
  int bench_##fn() {                                                    \
    ...
    for (i=0; i < niter; ++i) {                                         \
      x = _mm_max_ps(_mm_min_ps(fn(x), bmax), bmin);      \
    }                                                                   \
...
#define DECL_VECTOR_FN_BENCH64(fn)                                        \
  int bench_##fn() {                                                    \
    ...
    for (i=0; i < niter; ++i) {                                         \
      x = _mm_max_pd(_mm_min_pd(fn(x), bmax), bmin);      \
    }                                                                   \
...
#ifdef __AVX__
#define DECL_VECTOR_FN_BENCH256(fn)                                        \
  int bench_##fn() {                                                    \
    int niter = 100000,i;                                                \
    v8sf bmin = _mm256_set1_ps(0.5), bmax = _mm256_set1_ps(1.0);              \
    v8sf x = _mm256_set1_ps(0.75);                                         \
    for (i=0; i < niter; ++i) {                                         \
      x = _mm256_max_ps(_mm256_min_ps(fn(x), bmax), bmin);      \
    }                                                                   \
    if (((float*)&x)[0] == 2.32132323232f) niter--;                     \
    return niter;                                                       \
  }

#define DECL_VECTOR_FN_BENCH256D(fn)                                        \
  int bench_##fn() {                                                    \
    int niter = 100000,i;                                                \
    v4df bmin = _mm256_set1_pd(0.5), bmax = _mm256_set1_pd(1.0);              \
    v4df x = _mm256_set1_pd(0.75);                                         \
    for (i=0; i < niter; ++i) {                                         \
      x = _mm256_max_pd(_mm256_min_pd(fn(x), bmax), bmin);      \
    }                                                                   \
    if (((double*)&x)[0] == 2.32132323232) niter--;                     \
    return niter;                                                       \
  }

#define DECL_VECTOR_CAST_BENCH256(fn)                                        \
  int bench_##fn() {                                                    \
    int niter = 100000,i;                                                \
    v8sf bmin = _mm256_set1_ps(0.5), bmax = _mm256_set1_ps(2.0);              \
    v8si x = _mm256_set1_epi32(1);                                         \
    for (i=0; i < niter; ++i) {                                         \
      x = (v8si) _mm256_max_ps(_mm256_min_ps(fn(x), bmax), bmin);      \
    }                                                                   \
    if (((float*)&x)[0] == 2.32132323232f) niter--;                     \
    return niter;                                                       \
  }
...
#define DECL_VECTOR_CAST_BENCH(fn)                                        \
  int bench_##fn() {                                                    \
    int niter = 100000,i;                                                \
    v4sf bmin = _mm_set1_ps(0.5), bmax = _mm_set1_ps(2.0);              \
    v4si x = _mm_set1_epi32(1);                                         \
    for (i=0; i < niter; ++i) {                                         \
      x = (v4si) _mm_max_ps(_mm_min_ps(fn(x), bmax), bmin);      \
    }                                                                   \
    if (((float*)&x)[0] == 2.32132323232f) niter--;                     \
    return niter;                                                       \
  }

#define DECL_VECTOR_CAST_BENCH64(fn)                                        \
  int bench_##fn() {                                                    \
    int niter = 100000,i;                                                \
    v2df bmin = _mm_set1_pd(0.5), bmax = _mm_set1_pd(2.0);              \
    v4si x = _mm_set1_epi32(1);                                         \
    for (i=0; i < niter; ++i) {                                         \
      x = (v4si) _mm_max_pd(_mm_min_pd(fn(x), bmax), bmin);      \
    }                                                                   \
    if (((float*)&x)[0] == 2.32132323232f) niter--;                     \
    return niter;                                                       \
  }
...
#ifdef __GNUC__
// 20131209: x87 code is no longer competitive
#undef HAVE_SINCOS_X86_FPU
...
static v4df _v4df_sign_mask;
static v4df _v4df_inv_sign_mask;
static v4df _v4df_1;
static v4df _v4df_0p5;
static v4df _v4df_cephes_FOPI;
static v4df _v4df_minus_cephes_DP1;
static v4df _v4df_minus_cephes_DP2;
static v4df _v4df_minus_cephes_DP3;
static v4df _v4df_sincof_p0;
static v4df _v4df_sincof_p1;
static v4df _v4df_sincof_p2;
static v4df _v4df_coscof_p0;
static v4df _v4df_coscof_p1;
static v4df _v4df_coscof_p2;
static v8sf _v8sf_sign_mask;
static v8sf _v8sf_inv_sign_mask;
static v8sf _v8sf_1;
static v8sf _v8sf_0p5;
static v8sf _v8sf_cephes_FOPI;
static v8sf _v8sf_minus_cephes_DP1;
static v8sf _v8sf_minus_cephes_DP2;
static v8sf _v8sf_minus_cephes_DP3;
static v8sf _v8sf_sincof_p0;
static v8sf _v8sf_sincof_p1;
static v8sf _v8sf_sincof_p2;
static v8sf _v8sf_coscof_p0;
static v8sf _v8sf_coscof_p1;
static v8sf _v8sf_coscof_p2;
static v4si _v4si_pi32_1;
static v4si _v4si_pi32_inv1;
static v4si _v4si_pi32_2;
static v4si _v4si_pi32_4;

inline v4df sin_pd4(v4df x)
{
	...
	x = _mm256_and_pd(x, _v4df_inv_sign_mask);
	/* extract the sign bit (upper one) */
	sign_bit = _mm256_and_pd(sign_bit, _v4df_sign_mask);

	/* scale by 4/Pi */
	y = _mm256_mul_pd(x, _v4df_cephes_FOPI);

	/* store the integer part of y in mm0 */
	/* j=(j+1) & (~1) (see the cephes sources) */
	emm2 = _mm_and_si128(_mm_add_epi32(_mm256_cvttpd_epi32(y), _v4si_pi32_1), _v4si_pi32_inv1);
	y = _mm256_cvtepi32_pd(emm2);
	/* get the swap sign flag */
	emm0 = _mm_slli_epi32(_mm_and_si128(emm2, _v4si_pi32_4), 29);
	 ...
	 */
	emm2 = _mm_cmpeq_epi32(_mm_and_si128(emm2, _v4si_pi32_2), _mm_setzero_si128());
	...
	x = _mm256_add_pd( _mm256_add_pd( _mm256_add_pd(x, _mm256_mul_pd(y, _v4df_minus_cephes_DP1)), _mm256_mul_pd(y, _v4df_minus_cephes_DP2)), _mm256_mul_pd(y, _v4df_minus_cephes_DP3));

	/* Evaluate the first polynom  (0 <= x <= Pi/4) */
	y = _v4df_coscof_p0;
	z = _mm256_mul_pd(x,x);

	y = _mm256_add_pd( _mm256_sub_pd( _mm256_mul_pd( _mm256_mul_pd( _mm256_add_pd( _mm256_mul_pd( _mm256_add_pd( _mm256_mul_pd(y, z), _v4df_coscof_p1), z), _v4df_coscof_p2), z), z), _mm256_mul_pd(z, _v4df_0p5) ), _v4df_1);

	/* Evaluate the second polynom  (Pi/4 <= x <= 0) */

	y2 = _mm256_add_pd( _mm256_mul_pd( _mm256_mul_pd( _mm256_add_pd( _mm256_mul_pd( _mm256_add_pd( _mm256_mul_pd(_v4df_sincof_p0, z), _v4df_sincof_p1), z), _v4df_sincof_p2), z), x), x);
...
inline v4df cos_pd4(v4df x)
{
	...
	emm2 = _mm_sub_epi32(emm2, _v4si_pi32_2);

	/* get the swap sign flag */
	emm0 = _mm_slli_epi32( _mm_andnot_si128(emm2, _v4si_pi32_4), 29);
	/* get the polynom selection mask */
	emm2 = _mm_cmpeq_epi32( _mm_and_si128(emm2, _v4si_pi32_2), _mm_setzero_si128());
...
inline v8sf sin_ps8(v8sf x)
{
	...
	sign_bit = x;
	/* take the absolute value */
	x = _mm256_and_ps(x, _v8sf_inv_sign_mask);
	/* extract the sign bit (upper one) */
	sign_bit = _mm256_and_ps(sign_bit, _v8sf_sign_mask);

	/* scale by 4/Pi */
	y = _mm256_mul_ps(x, _v8sf_cephes_FOPI);
	...
	/* The magic pass: "Extended precision modular arithmetic"
	 x = ((x - y * DP1) - y * DP2) - y * DP3; */
	x = _mm256_add_ps(_mm256_add_ps(_mm256_add_ps(x, _mm256_mul_ps(y, _v8sf_minus_cephes_DP1)), _mm256_mul_ps(y, _v8sf_minus_cephes_DP2)), _mm256_mul_ps(y, _v8sf_minus_cephes_DP3));

	/* Evaluate the first polynom  (0 <= x <= Pi/4) */
	y = _v8sf_coscof_p0;
	z = _mm256_mul_ps(x,x);
	tmp = _mm256_mul_ps(z, _v8sf_0p5);
	y = _mm256_add_ps( _mm256_sub_ps( _mm256_mul_ps( _mm256_mul_ps( _mm256_add_ps( _mm256_mul_ps( _mm256_add_ps(_mm256_mul_ps(y, z), _v8sf_coscof_p1), z), _v8sf_coscof_p2), z), z), tmp), _v8sf_1);

	/* Evaluate the second polynom  (Pi/4 <= x <= 0) */

	y2 = _v8sf_sincof_p0;
	y2 = _mm256_add_ps( _mm256_mul_ps( _mm256_mul_ps( _mm256_add_ps( _mm256_mul_ps( _mm256_add_ps( _mm256_mul_ps(y2, z), _v8sf_sincof_p1), z), _v8sf_sincof_p2), z), x), x);
...
inline v8sf cos_ps8(v8sf x)
{
	...
	/* j=(j+1) & (~1) (see the cephes sources) */
	emm2[0] = _mm_and_si128(_mm_add_epi32(emm2[0], _v4si_pi32_1), _v4si_pi32_inv1);
	emm2[1] = _mm_and_si128(_mm_add_epi32(emm2[1], _v4si_pi32_1), _v4si_pi32_inv1);
	((v4sf*)&y)[0] = _mm_cvtepi32_ps(emm2[0]);
	((v4sf*)&y)[1] = _mm_cvtepi32_ps(emm2[1]);
	emm2[0] = _mm_sub_epi32(emm2[0], _v4si_pi32_2);
	emm2[1] = _mm_sub_epi32(emm2[1], _v4si_pi32_2);

	/* get the swap sign flag */
	emm0[0] = _mm_slli_epi32(_mm_andnot_si128(emm2[0], _v4si_pi32_4), 29);
	emm0[1] = _mm_slli_epi32(_mm_andnot_si128(emm2[1], _v4si_pi32_4), 29);
	/* get the polynom selection mask */
	emm2[0] = _mm_cmpeq_epi32(_mm_and_si128(emm2[0], _v4si_pi32_2), _mm_setzero_si128());
	emm2[1] = _mm_cmpeq_epi32(_mm_and_si128(emm2[1], _v4si_pi32_2), _mm_setzero_si128());
...
DECL_VECTOR_FN_BENCH256(sin_ps8);
DECL_VECTOR_FN_BENCH256(cos_ps8);
DECL_VECTOR_FN_BENCH256D(sin_pd4);
DECL_VECTOR_FN_BENCH256D(cos_pd4);
DECL_VECTOR_CAST_BENCH256(_mm256_castsi256_ps);

#endif // __AVX__

DECL_VECTOR_CAST_BENCH(_mm_castsi128_ps);
DECL_VECTOR_CAST_BENCH64(_mm_castsi128_pd);

void run_bench(const char *s, int (*fn)()) {
  printf("benching %20s ..", s); fflush(stdout);
  double t0 = uclock_sec(), t1, tmax = 2.0;
  double niter = 0;
  do {
    niter += fn();
    t1 = uclock_sec();
...
void sanity_check() {
  ...
  mm0 = _mm_cvttps_v4si_pi32(w.v);
  w.v = _mm_movehl_ps(w.v,w.v);
  mm1 = _mm_cvttps_v4si_pi32(w.v);
  /*_mm_empty();
  printf("truncation to int: "); print2i(mm0); print2i(mm1); printf("\n");
  */
...
#ifdef __AVX__
	_v4df_sign_mask = _mm256_set1_pd(0x8000000000000000LL);
	_v4df_inv_sign_mask = _mm256_set1_pd(~0x8000000000000000LL);
	_v4df_1 = _mm256_set1_pd(1.0);
	_v4df_0p5 = _mm256_set1_pd(0.5);
	_v4df_cephes_FOPI = _mm256_set1_pd(1.27323954473516);
	_v4df_minus_cephes_DP1 = _mm256_set1_pd(-0.78515625);
	_v4df_minus_cephes_DP2 = _mm256_set1_pd(-2.4187564849853515625e-4);
	_v4df_minus_cephes_DP3 = _mm256_set1_pd(-3.77489497744594108e-8);
	_v4df_sincof_p0 = _mm256_set1_pd(-1.9515295891E-4);
	_v4df_sincof_p1 = _mm256_set1_pd( 8.3321608736E-3);
	_v4df_sincof_p2 = _mm256_set1_pd(-1.6666654611E-1);
	_v4df_coscof_p0 = _mm256_set1_pd( 2.443315711809948E-005);
	_v4df_coscof_p1 = _mm256_set1_pd(-1.388731625493765E-003);
	_v4df_coscof_p2 = _mm256_set1_pd( 4.166664568298827E-002);
	_v8sf_sign_mask = _mm256_set1_ps(0x8000000000000000LL);
	_v8sf_inv_sign_mask = _mm256_set1_ps(~0x8000000000000000LL);
	_v8sf_1 = _mm256_set1_ps(1.0);
	_v8sf_0p5 = _mm256_set1_ps(0.5);
	_v8sf_cephes_FOPI = _mm256_set1_ps(1.27323954473516);
	_v8sf_minus_cephes_DP1 = _mm256_set1_ps(-0.78515625);
	_v8sf_minus_cephes_DP2 = _mm256_set1_ps(-2.4187564849853515625e-4);
	_v8sf_minus_cephes_DP3 = _mm256_set1_ps(-3.77489497744594108e-8);
	_v8sf_sincof_p0 = _mm256_set1_ps(-1.9515295891E-4);
	_v8sf_sincof_p1 = _mm256_set1_ps( 8.3321608736E-3);
	_v8sf_sincof_p2 = _mm256_set1_ps(-1.6666654611E-1);
	_v8sf_coscof_p0 = _mm256_set1_ps( 2.443315711809948E-005);
	_v8sf_coscof_p1 = _mm256_set1_ps(-1.388731625493765E-003);
	_v8sf_coscof_p2 = _mm256_set1_ps( 4.166664568298827E-002);
	_v4si_pi32_1 = _mm_set1_epi32(1);
	_v4si_pi32_inv1 = _mm_set1_epi32(~1);
	_v4si_pi32_2 = _mm_set1_epi32(2);
	_v4si_pi32_4 = _mm_set1_epi32(4);
#endif //__AVX__
...
#ifdef __AVX__
  run_bench("sin_ps8", bench_sin_ps8);
  run_bench("cos_ps8", bench_cos_ps8);
  run_bench("sin_pd4", bench_sin_pd4);
  run_bench("cos_pd4", bench_cos_pd4);
  run_bench("_mm256_castsi256_ps", bench__mm256_castsi256_ps);
#endif // __AVX__
  run_bench("_mm_castsi128_ps", bench__mm_castsi128_ps);
  run_bench("_mm_castsi128_pd", bench__mm_castsi128_pd);
