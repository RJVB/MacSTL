...
DEFINE_VEC_COMMON_UNARY_FUNCTION(round,round)
...
#define DEFINE_VEC_PLATFORM_UNARY_FUNCTION_WITH_CONSTINT(FN,DESC)											\
																									\
template <const int i, typename T> struct FN##_function;													\
																									\
...
#define DEFINE_VEC_PLATFORM_BINARY_FUNCTION_WITH_CONSTINT(FN,DESC)										\
																									\
template <const int i, typename T1, typename T2 = T1> struct FN##_function;								\
																									\
template <const int i, typename T1, typename T2>													\
	INLINE const typename FN##_function <i, typename macstl::impl::data_vec <T1>::type, typename macstl::impl::data_vec <T2>::type>::result_type FN (const T1& lhs, const T2& rhs)					\
	{																								\
		return FN##_function <i, typename macstl::impl::data_vec <T1>::type, typename macstl::impl::data_vec <T2>::type> () (lhs, rhs);														\
	}
...
#	include "impl/vec_avx.h"
#elif defined(__MMX__) || defined(__SSE__) || defined(__SSE2__)
